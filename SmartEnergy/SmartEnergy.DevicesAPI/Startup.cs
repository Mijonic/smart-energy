...
namespace SmartEnergy.DevicesAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           .AddJwtBearer(options =>
           {
            ...
            services.AddDbContext<DeviceDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DeviceDatabase")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            using (var serviceScope = app.ApplicationServices.GetRequiredService<IServiceScopeFactory>().CreateScope())
            {
                ...
                while (!migrated && attempts > 0)
                {
                    ...
                    try
                    {
                        var context = serviceScope.ServiceProvider.GetService<DeviceDbContext>();
